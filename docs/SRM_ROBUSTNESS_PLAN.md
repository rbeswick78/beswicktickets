...
**Phase 0 commit state:** merged and pushed to `main` (commit `ccc1b30` + doc updates). Phase 1 onward works directly on `main` per the workflow above. Phase 1 = `bcee21c`; Phase 2 committed and pushed to `main` (see git log).
